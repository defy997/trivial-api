...
%token DISTINCT GROUP USING INDEX TABLE DATABASE DATABASES TABLES
...
%type <val_s> create_database_stmt use_database_stmt drop_database_stmt show_database_stmt show_databases_stmt
%type <val_s> drop_table_stmt show_table_stmt show_tables_stmt
...
sql_stmt   :  create_table_stmt ';'    { execute_create_table($1); }
		   ...
		   |  show_databases_stmt ';'  { execute_show_databases(); }
		   |  show_tables_stmt ';'     { execute_show_tables(); }
...
show_databases_stmt  : SHOW DATABASES                 { $$ = NULL; };
show_tables_stmt     : SHOW TABLES                     { $$ = NULL; };
